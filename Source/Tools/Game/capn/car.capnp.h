...
enum cereal_CarEvent_EventName {
	...
	cereal_CarEvent_EventName_gasUnavailableDEPRECATED = 3,
	...
	cereal_CarEvent_EventName_dataNeededDEPRECATED = 16,
	...
	cereal_CarEvent_EventName_ipasOverrideDEPRECATED = 33,
	...
	cereal_CarEvent_EventName_geofenceDEPRECATED = 40,
	cereal_CarEvent_EventName_driverMonitorOnDEPRECATED = 41,
	cereal_CarEvent_EventName_driverMonitorOffDEPRECATED = 42,
	...
	cereal_CarEvent_EventName_calibrationProgressDEPRECATED = 47,
	cereal_CarEvent_EventName_lowBattery = 48,
	cereal_CarEvent_EventName_invalidGiraffeHondaDEPRECATED = 49,
	...
	cereal_CarEvent_EventName_invalidGiraffeToyotaDEPRECATED = 60,
	...
	cereal_CarEvent_EventName_invalidLkasSetting = 69,
	cereal_CarEvent_EventName_speedTooHigh = 70,
	cereal_CarEvent_EventName_laneChangeBlocked = 71,
	cereal_CarEvent_EventName_relayMalfunction = 72,
	cereal_CarEvent_EventName_gasPressed = 73,
	cereal_CarEvent_EventName_stockFcw = 74,
	cereal_CarEvent_EventName_startup = 75,
	cereal_CarEvent_EventName_startupNoCar = 76,
	cereal_CarEvent_EventName_startupNoControl = 77,
	cereal_CarEvent_EventName_startupMaster = 78,
	cereal_CarEvent_EventName_fcw = 79,
	cereal_CarEvent_EventName_steerSaturated = 80,
	cereal_CarEvent_EventName_whitePandaUnsupportedDEPRECATED = 81,
	cereal_CarEvent_EventName_startupGreyPandaDEPRECATED = 82,
	cereal_CarEvent_EventName_canErrorPersistentDEPRECATED = 83,
	cereal_CarEvent_EventName_belowEngageSpeed = 84,
	cereal_CarEvent_EventName_noGps = 85,
	cereal_CarEvent_EventName_focusRecoverActiveDEPRECATED = 86,
	cereal_CarEvent_EventName_wrongCruiseMode = 87,
	cereal_CarEvent_EventName_neosUpdateRequiredDEPRECATED = 88,
	cereal_CarEvent_EventName_modeldLagging = 89,
	cereal_CarEvent_EventName_deviceFalling = 90,
	cereal_CarEvent_EventName_fanMalfunction = 91,
	cereal_CarEvent_EventName_cameraMalfunction = 92,
	cereal_CarEvent_EventName_modelLagWarningDEPRECATED = 93
};
...
enum cereal_CarControl_HUDControl_AudibleAlert {
	...
	cereal_CarControl_HUDControl_AudibleAlert_chimeWarning2Repeat = 8
};
...
enum cereal_CarParams_SafetyModel {
	...
	cereal_CarParams_SafetyModel_subaruLegacy = 22,
	cereal_CarParams_SafetyModel_hyundaiLegacy = 23,
	cereal_CarParams_SafetyModel_hyundaiCommunity = 24
};
...
enum cereal_CarParams_TransmissionType {
	...
	cereal_CarParams_TransmissionType_direct = 3
};
...
enum cereal_CarParams_Ecu {
	...
	cereal_CarParams_Ecu_transmission = 8,
	cereal_CarParams_Ecu_srs = 9,
	cereal_CarParams_Ecu_gateway = 10,
	cereal_CarParams_Ecu_hud = 11,
	cereal_CarParams_Ecu_combinationMeter = 12,
	cereal_CarParams_Ecu_vsa = 13,
	cereal_CarParams_Ecu_programmedFuelInjection = 14,
	cereal_CarParams_Ecu_electricBrakeBooster = 15,
	cereal_CarParams_Ecu_shiftByWire = 16
};
...
enum cereal_CarParams_NetworkLocation {
	cereal_CarParams_NetworkLocation_fwdCamera = 0,
	cereal_CarParams_NetworkLocation_gateway = 1
};
...
struct cereal_CarState {
	...
	unsigned steerWarning : 1;
	unsigned steerError : 1;
	unsigned stockAeb : 1;
	unsigned stockFcw : 1;
	unsigned espDisabled : 1;
	...
	unsigned leftBlindspot : 1;
	unsigned rightBlindspot : 1;
};
...
struct cereal_CarParams {
	...
	enum cereal_CarParams_NetworkLocation networkLocation;
	unsigned hasZss : 1;
};

static const size_t cereal_CarParams_word_count = 11;

static const size_t cereal_CarParams_pointer_count = 13;

static const size_t cereal_CarParams_struct_bytes_count = 192;
...
struct cereal_CarParams_LateralPIDTuning {
	...
	capn_list32 kdV;
	float kf;
	unsigned newKfTuned : 1;
};

static const size_t cereal_CarParams_LateralPIDTuning_word_count = 1;

static const size_t cereal_CarParams_LateralPIDTuning_pointer_count = 6;

static const size_t cereal_CarParams_LateralPIDTuning_struct_bytes_count = 56;
...
struct cereal_CarParams_LateralINDITuning {
	capn_list32 outerLoopGainBP;
	capn_list32 outerLoopGainV;
	float innerLoopGain;
	float timeConstant;
...
static const size_t cereal_CarParams_LateralINDITuning_pointer_count = 2;

static const size_t cereal_CarParams_LateralINDITuning_struct_bytes_count = 32;
