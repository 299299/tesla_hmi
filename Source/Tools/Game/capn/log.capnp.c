...
void cereal_read_FrameData(struct cereal_FrameData *s, cereal_FrameData_ptr p) {
	...
	s->focusVal.p = capn_getp(p.p, 3, 0);
	s->focusConf.p = capn_getp(p.p, 4, 0);
	s->sharpnessScore.p = capn_getp(p.p, 5, 0);
	s->recoverState = (int32_t) ((int32_t)capn_read32(p.p, 60));
...
void cereal_write_FrameData(const struct cereal_FrameData *s, cereal_FrameData_ptr p) {
	...
	capn_setp(p.p, 3, s->focusVal.p);
	capn_setp(p.p, 4, s->focusConf.p);
	capn_setp(p.p, 5, s->sharpnessScore.p);
	capn_write32(p.p, 60, (uint32_t) (s->recoverState));
...
void cereal_read_SensorEventData(struct cereal_SensorEventData *s, cereal_SensorEventData_ptr p) {
	...
	case cereal_SensorEventData_temperature:
		s->temperature = capn_to_f32(capn_read32(p.p, 28));
		break;
...
void cereal_write_SensorEventData(const struct cereal_SensorEventData *s, cereal_SensorEventData_ptr p) {
	...
	case cereal_SensorEventData_light:
	case cereal_SensorEventData_temperature:
		capn_write32(p.p, 28, capn_from_f32(s->temperature));
		break;
	case cereal_SensorEventData_acceleration:
	case cereal_SensorEventData_magnetic:
	case cereal_SensorEventData_orientation:
...
void cereal_read_ThermalData(struct cereal_ThermalData *s, cereal_ThermalData_ptr p) {
	capn_resolve(&p.p);
	s->cpu0DEPRECATED = capn_read16(p.p, 0);
	s->cpu1DEPRECATED = capn_read16(p.p, 2);
	s->cpu2DEPRECATED = capn_read16(p.p, 4);
	s->cpu3DEPRECATED = capn_read16(p.p, 6);
	s->memDEPRECATED = capn_read16(p.p, 8);
	s->gpuDEPRECATED = capn_read16(p.p, 10);
	s->batDEPRECATED = capn_read32(p.p, 12);
	s->pa0DEPRECATED = capn_read16(p.p, 46);
	...
	s->networkStrength = (enum cereal_ThermalData_NetworkStrength)(int) capn_read16(p.p, 50);
	s->carBatteryCapacity = capn_read32(p.p, 56);
	...
	s->cpu.p = capn_getp(p.p, 1, 0);
	s->gpu.p = capn_getp(p.p, 2, 0);
	s->mem = capn_to_f32(capn_read32(p.p, 60));
	s->bat = capn_to_f32(capn_read32(p.p, 64));
	s->ambient = capn_to_f32(capn_read32(p.p, 68));
}
void cereal_write_ThermalData(const struct cereal_ThermalData *s, cereal_ThermalData_ptr p) {
	capn_resolve(&p.p);
	capn_write16(p.p, 0, s->cpu0DEPRECATED);
	capn_write16(p.p, 2, s->cpu1DEPRECATED);
	capn_write16(p.p, 4, s->cpu2DEPRECATED);
	capn_write16(p.p, 6, s->cpu3DEPRECATED);
	capn_write16(p.p, 8, s->memDEPRECATED);
	capn_write16(p.p, 10, s->gpuDEPRECATED);
	capn_write32(p.p, 12, s->batDEPRECATED);
	capn_write16(p.p, 46, s->pa0DEPRECATED);
	...
	capn_write16(p.p, 50, (uint16_t) (s->networkStrength));
	capn_write32(p.p, 56, s->carBatteryCapacity);
	...
	capn_setp(p.p, 1, s->cpu.p);
	capn_setp(p.p, 2, s->gpu.p);
	capn_write32(p.p, 60, capn_from_f32(s->mem));
	capn_write32(p.p, 64, capn_from_f32(s->bat));
	capn_write32(p.p, 68, capn_from_f32(s->ambient));
}
...
void cereal_read_LiveCalibrationData(struct cereal_LiveCalibrationData *s, cereal_LiveCalibrationData_ptr p) {
	...
	s->validBlocks = (int32_t) ((int32_t)capn_read32(p.p, 8));
	s->extrinsicMatrix.p = capn_getp(p.p, 1, 0);
	s->rpyCalib.p = capn_getp(p.p, 4, 0);
	s->rpyCalibSpread.p = capn_getp(p.p, 5, 0);
}
void cereal_write_LiveCalibrationData(const struct cereal_LiveCalibrationData *s, cereal_LiveCalibrationData_ptr p) {
	...
	capn_write32(p.p, 8, (uint32_t) (s->validBlocks));
	capn_setp(p.p, 1, s->extrinsicMatrix.p);
	capn_setp(p.p, 4, s->rpyCalib.p);
	capn_setp(p.p, 5, s->rpyCalibSpread.p);
}
...
cereal_ModelData_ptr cereal_new_ModelData(struct capn_segment *s) {
	...
	p.p = capn_new_struct(s, 24, 11);
	return p;
}
cereal_ModelData_list cereal_new_ModelData_list(struct capn_segment *s, int len) {
	cereal_ModelData_list p;
	p.p = capn_new_list(s, len, 24, 11);
	return p;
}
void cereal_read_ModelData(struct cereal_ModelData *s, cereal_ModelData_ptr p) {
	capn_resolve(&p.p);
	s->frameId = capn_read32(p.p, 0);
	s->frameAge = capn_read32(p.p, 4);
	s->frameDropPerc = capn_to_f32(capn_read32(p.p, 16));
	s->timestampEof = capn_read64(p.p, 8);
	s->modelExecutionTime = capn_to_f32(capn_read32(p.p, 20));
	s->rawPred = capn_get_data(p.p, 10);
...
void cereal_write_ModelData(const struct cereal_ModelData *s, cereal_ModelData_ptr p) {
	capn_resolve(&p.p);
	capn_write32(p.p, 0, s->frameId);
	capn_write32(p.p, 4, s->frameAge);
	capn_write32(p.p, 16, capn_from_f32(s->frameDropPerc));
	capn_write64(p.p, 8, s->timestampEof);
	capn_write32(p.p, 20, capn_from_f32(s->modelExecutionTime));
	capn_setp(p.p, 10, s->rawPred.p);
...
void cereal_read_ModelData_PathData(struct cereal_ModelData_PathData *s, cereal_ModelData_PathData_ptr p) {
	...
	s->validLen = capn_to_f32(capn_read32(p.p, 8));
}
void cereal_write_ModelData_PathData(const struct cereal_ModelData_PathData *s, cereal_ModelData_PathData_ptr p) {
	...
	capn_write32(p.p, 8, capn_from_f32(s->validLen));
}
...
void cereal_read_ModelData_MetaData(struct cereal_ModelData_MetaData *s, cereal_ModelData_MetaData_ptr p) {
	...
	s->desireState.p = capn_getp(p.p, 1, 0);
}
void cereal_write_ModelData_MetaData(const struct cereal_ModelData_MetaData *s, cereal_ModelData_MetaData_ptr p) {
	...
	capn_setp(p.p, 1, s->desireState.p);
}
...
void cereal_read_ModelData_LongitudinalData(struct cereal_ModelData_LongitudinalData *s, cereal_ModelData_LongitudinalData_ptr p) {
	capn_resolve(&p.p);
	s->distances.p = capn_getp(p.p, 2, 0);
...
cereal_ModelDataV2_ptr cereal_new_ModelDataV2(struct capn_segment *s) {
	cereal_ModelDataV2_ptr p;
	p.p = capn_new_struct(s, 24, 12);
	return p;
}
cereal_ModelDataV2_list cereal_new_ModelDataV2_list(struct capn_segment *s, int len) {
	cereal_ModelDataV2_list p;
	p.p = capn_new_list(s, len, 24, 12);
	return p;
}
void cereal_read_ModelDataV2(struct cereal_ModelDataV2 *s, cereal_ModelDataV2_ptr p) {
	capn_resolve(&p.p);
	s->frameId = capn_read32(p.p, 0);
	s->frameAge = capn_read32(p.p, 4);
	s->frameDropPerc = capn_to_f32(capn_read32(p.p, 8));
	s->timestampEof = capn_read64(p.p, 16);
	s->modelExecutionTime = capn_to_f32(capn_read32(p.p, 12));
	s->rawPred = capn_get_data(p.p, 11);
	s->position.p = capn_getp(p.p, 0, 0);
	s->orientation.p = capn_getp(p.p, 1, 0);
	s->velocity.p = capn_getp(p.p, 2, 0);
	s->orientationRate.p = capn_getp(p.p, 3, 0);
	s->laneLines.p = capn_getp(p.p, 4, 0);
	s->laneLineProbs.p = capn_getp(p.p, 5, 0);
	s->laneLineStds.p = capn_getp(p.p, 9, 0);
	s->roadEdges.p = capn_getp(p.p, 6, 0);
	s->roadEdgeStds.p = capn_getp(p.p, 10, 0);
	s->leads.p = capn_getp(p.p, 7, 0);
	s->meta.p = capn_getp(p.p, 8, 0);
}
void cereal_write_ModelDataV2(const struct cereal_ModelDataV2 *s, cereal_ModelDataV2_ptr p) {
	capn_resolve(&p.p);
	capn_write32(p.p, 0, s->frameId);
	capn_write32(p.p, 4, s->frameAge);
	capn_write32(p.p, 8, capn_from_f32(s->frameDropPerc));
	capn_write64(p.p, 16, s->timestampEof);
	capn_write32(p.p, 12, capn_from_f32(s->modelExecutionTime));
	capn_setp(p.p, 11, s->rawPred.p);
	capn_setp(p.p, 0, s->position.p);
	capn_setp(p.p, 1, s->orientation.p);
	capn_setp(p.p, 2, s->velocity.p);
	capn_setp(p.p, 3, s->orientationRate.p);
	capn_setp(p.p, 4, s->laneLines.p);
	capn_setp(p.p, 5, s->laneLineProbs.p);
	capn_setp(p.p, 9, s->laneLineStds.p);
	capn_setp(p.p, 6, s->roadEdges.p);
	capn_setp(p.p, 10, s->roadEdgeStds.p);
	capn_setp(p.p, 7, s->leads.p);
	capn_setp(p.p, 8, s->meta.p);
}
void cereal_get_ModelDataV2(struct cereal_ModelDataV2 *s, cereal_ModelDataV2_list l, int i) {
	cereal_ModelDataV2_ptr p;
	p.p = capn_getp(l.p, i, 0);
	cereal_read_ModelDataV2(s, p);
}
void cereal_set_ModelDataV2(const struct cereal_ModelDataV2 *s, cereal_ModelDataV2_list l, int i) {
	cereal_ModelDataV2_ptr p;
	p.p = capn_getp(l.p, i, 0);
	cereal_write_ModelDataV2(s, p);
}

cereal_ModelDataV2_XYZTData_ptr cereal_new_ModelDataV2_XYZTData(struct capn_segment *s) {
	cereal_ModelDataV2_XYZTData_ptr p;
	p.p = capn_new_struct(s, 0, 7);
	return p;
}
cereal_ModelDataV2_XYZTData_list cereal_new_ModelDataV2_XYZTData_list(struct capn_segment *s, int len) {
	cereal_ModelDataV2_XYZTData_list p;
	p.p = capn_new_list(s, len, 0, 7);
	return p;
}
void cereal_read_ModelDataV2_XYZTData(struct cereal_ModelDataV2_XYZTData *s, cereal_ModelDataV2_XYZTData_ptr p) {
	capn_resolve(&p.p);
	s->x.p = capn_getp(p.p, 0, 0);
	s->y.p = capn_getp(p.p, 1, 0);
	s->z.p = capn_getp(p.p, 2, 0);
	s->t.p = capn_getp(p.p, 3, 0);
	s->xStd.p = capn_getp(p.p, 4, 0);
	s->yStd.p = capn_getp(p.p, 5, 0);
	s->zStd.p = capn_getp(p.p, 6, 0);
}
void cereal_write_ModelDataV2_XYZTData(const struct cereal_ModelDataV2_XYZTData *s, cereal_ModelDataV2_XYZTData_ptr p) {
	capn_resolve(&p.p);
	capn_setp(p.p, 0, s->x.p);
	capn_setp(p.p, 1, s->y.p);
	capn_setp(p.p, 2, s->z.p);
	capn_setp(p.p, 3, s->t.p);
	capn_setp(p.p, 4, s->xStd.p);
	capn_setp(p.p, 5, s->yStd.p);
	capn_setp(p.p, 6, s->zStd.p);
}
void cereal_get_ModelDataV2_XYZTData(struct cereal_ModelDataV2_XYZTData *s, cereal_ModelDataV2_XYZTData_list l, int i) {
	cereal_ModelDataV2_XYZTData_ptr p;
	p.p = capn_getp(l.p, i, 0);
	cereal_read_ModelDataV2_XYZTData(s, p);
}
void cereal_set_ModelDataV2_XYZTData(const struct cereal_ModelDataV2_XYZTData *s, cereal_ModelDataV2_XYZTData_list l, int i) {
	cereal_ModelDataV2_XYZTData_ptr p;
	p.p = capn_getp(l.p, i, 0);
	cereal_write_ModelDataV2_XYZTData(s, p);
}

cereal_ModelDataV2_LeadDataV2_ptr cereal_new_ModelDataV2_LeadDataV2(struct capn_segment *s) {
	cereal_ModelDataV2_LeadDataV2_ptr p;
	p.p = capn_new_struct(s, 8, 2);
	return p;
}
cereal_ModelDataV2_LeadDataV2_list cereal_new_ModelDataV2_LeadDataV2_list(struct capn_segment *s, int len) {
	cereal_ModelDataV2_LeadDataV2_list p;
	p.p = capn_new_list(s, len, 8, 2);
	return p;
}
void cereal_read_ModelDataV2_LeadDataV2(struct cereal_ModelDataV2_LeadDataV2 *s, cereal_ModelDataV2_LeadDataV2_ptr p) {
	capn_resolve(&p.p);
	s->prob = capn_to_f32(capn_read32(p.p, 0));
	s->t = capn_to_f32(capn_read32(p.p, 4));
	s->xyva.p = capn_getp(p.p, 0, 0);
	s->xyvaStd.p = capn_getp(p.p, 1, 0);
}
void cereal_write_ModelDataV2_LeadDataV2(const struct cereal_ModelDataV2_LeadDataV2 *s, cereal_ModelDataV2_LeadDataV2_ptr p) {
	capn_resolve(&p.p);
	capn_write32(p.p, 0, capn_from_f32(s->prob));
	capn_write32(p.p, 4, capn_from_f32(s->t));
	capn_setp(p.p, 0, s->xyva.p);
	capn_setp(p.p, 1, s->xyvaStd.p);
}
void cereal_get_ModelDataV2_LeadDataV2(struct cereal_ModelDataV2_LeadDataV2 *s, cereal_ModelDataV2_LeadDataV2_list l, int i) {
	cereal_ModelDataV2_LeadDataV2_ptr p;
	p.p = capn_getp(l.p, i, 0);
	cereal_read_ModelDataV2_LeadDataV2(s, p);
}
void cereal_set_ModelDataV2_LeadDataV2(const struct cereal_ModelDataV2_LeadDataV2 *s, cereal_ModelDataV2_LeadDataV2_list l, int i) {
	cereal_ModelDataV2_LeadDataV2_ptr p;
	p.p = capn_getp(l.p, i, 0);
	cereal_write_ModelDataV2_LeadDataV2(s, p);
}

cereal_ModelDataV2_MetaData_ptr cereal_new_ModelDataV2_MetaData(struct capn_segment *s) {
	cereal_ModelDataV2_MetaData_ptr p;
	p.p = capn_new_struct(s, 16, 2);
	return p;
}
cereal_ModelDataV2_MetaData_list cereal_new_ModelDataV2_MetaData_list(struct capn_segment *s, int len) {
	cereal_ModelDataV2_MetaData_list p;
	p.p = capn_new_list(s, len, 16, 2);
	return p;
}
void cereal_read_ModelDataV2_MetaData(struct cereal_ModelDataV2_MetaData *s, cereal_ModelDataV2_MetaData_ptr p) {
	capn_resolve(&p.p);
	s->engagedProb = capn_to_f32(capn_read32(p.p, 0));
	s->desirePrediction.p = capn_getp(p.p, 0, 0);
	s->brakeDisengageProb = capn_to_f32(capn_read32(p.p, 4));
...
void cereal_write_ModelDataV2_MetaData(const struct cereal_ModelDataV2_MetaData *s, cereal_ModelDataV2_MetaData_ptr p) {
	capn_resolve(&p.p);
	capn_write32(p.p, 0, capn_from_f32(s->engagedProb));
	capn_setp(p.p, 0, s->desirePrediction.p);
	capn_write32(p.p, 4, capn_from_f32(s->brakeDisengageProb));
...
void cereal_get_ModelDataV2_MetaData(struct cereal_ModelDataV2_MetaData *s, cereal_ModelDataV2_MetaData_list l, int i) {
	cereal_ModelDataV2_MetaData_ptr p;
	p.p = capn_getp(l.p, i, 0);
	cereal_read_ModelDataV2_MetaData(s, p);
}
void cereal_set_ModelDataV2_MetaData(const struct cereal_ModelDataV2_MetaData *s, cereal_ModelDataV2_MetaData_list l, int i) {
	cereal_ModelDataV2_MetaData_ptr p;
	p.p = capn_getp(l.p, i, 0);
	cereal_write_ModelDataV2_MetaData(s, p);
}
...
void cereal_read_EncodeIndex(struct cereal_EncodeIndex *s, cereal_EncodeIndex_ptr p) {
	...
	s->timestampSof = capn_read64(p.p, 24);
	s->timestampEof = capn_read64(p.p, 32);
}
void cereal_write_EncodeIndex(const struct cereal_EncodeIndex *s, cereal_EncodeIndex_ptr p) {
	...
	capn_write64(p.p, 24, s->timestampSof);
	capn_write64(p.p, 32, s->timestampEof);
}
...
cereal_LiveLocationKalman_ptr cereal_new_LiveLocationKalman(struct capn_segment *s) {
	cereal_LiveLocationKalman_ptr p;
	p.p = capn_new_struct(s, 24, 14);
	return p;
}
cereal_LiveLocationKalman_list cereal_new_LiveLocationKalman_list(struct capn_segment *s, int len) {
	cereal_LiveLocationKalman_list p;
	p.p = capn_new_list(s, len, 24, 14);
	return p;
}
void cereal_read_LiveLocationKalman(struct cereal_LiveLocationKalman *s, cereal_LiveLocationKalman_ptr p) {
	capn_resolve(&p.p);
	s->positionECEF.p = capn_getp(p.p, 0, 0);
	s->positionGeodetic.p = capn_getp(p.p, 1, 0);
	s->velocityECEF.p = capn_getp(p.p, 2, 0);
	s->velocityNED.p = capn_getp(p.p, 3, 0);
	s->velocityDevice.p = capn_getp(p.p, 4, 0);
	s->accelerationDevice.p = capn_getp(p.p, 5, 0);
	s->orientationECEF.p = capn_getp(p.p, 6, 0);
	s->calibratedOrientationECEF.p = capn_getp(p.p, 13, 0);
	s->orientationNED.p = capn_getp(p.p, 7, 0);
	s->angularVelocityDevice.p = capn_getp(p.p, 8, 0);
	s->orientationNEDCalibrated.p = capn_getp(p.p, 9, 0);
	s->velocityCalibrated.p = capn_getp(p.p, 10, 0);
	s->accelerationCalibrated.p = capn_getp(p.p, 11, 0);
	s->angularVelocityCalibrated.p = capn_getp(p.p, 12, 0);
	s->gpsWeek = (int32_t) ((int32_t)capn_read32(p.p, 0));
	s->gpsTimeOfWeek = capn_to_f64(capn_read64(p.p, 8));
	s->status = (enum cereal_LiveLocationKalman_Status)(int) capn_read16(p.p, 4);
	s->unixTimestampMillis = (int64_t) ((int64_t)(capn_read64(p.p, 16)));
	s->inputsOK = (capn_read8(p.p, 6) & 1) != 1;
	s->posenetOK = (capn_read8(p.p, 6) & 2) != 1;
	s->gpsOK = (capn_read8(p.p, 6) & 4) != 1;
	s->sensorsOK = (capn_read8(p.p, 6) & 8) != 1;
	s->deviceStable = (capn_read8(p.p, 6) & 16) != 1;
}
void cereal_write_LiveLocationKalman(const struct cereal_LiveLocationKalman *s, cereal_LiveLocationKalman_ptr p) {
	capn_resolve(&p.p);
	capn_setp(p.p, 0, s->positionECEF.p);
	capn_setp(p.p, 1, s->positionGeodetic.p);
	capn_setp(p.p, 2, s->velocityECEF.p);
	capn_setp(p.p, 3, s->velocityNED.p);
	capn_setp(p.p, 4, s->velocityDevice.p);
	capn_setp(p.p, 5, s->accelerationDevice.p);
	capn_setp(p.p, 6, s->orientationECEF.p);
	capn_setp(p.p, 13, s->calibratedOrientationECEF.p);
	capn_setp(p.p, 7, s->orientationNED.p);
	capn_setp(p.p, 8, s->angularVelocityDevice.p);
	capn_setp(p.p, 9, s->orientationNEDCalibrated.p);
	capn_setp(p.p, 10, s->velocityCalibrated.p);
	capn_setp(p.p, 11, s->accelerationCalibrated.p);
	capn_setp(p.p, 12, s->angularVelocityCalibrated.p);
	capn_write32(p.p, 0, (uint32_t) (s->gpsWeek));
	capn_write64(p.p, 8, capn_from_f64(s->gpsTimeOfWeek));
	capn_write16(p.p, 4, (uint16_t) (s->status));
	capn_write64(p.p, 16, (uint64_t) (s->unixTimestampMillis));
	capn_write1(p.p, 48, s->inputsOK != 1);
	capn_write1(p.p, 49, s->posenetOK != 1);
	capn_write1(p.p, 50, s->gpsOK != 1);
	capn_write1(p.p, 51, s->sensorsOK != 1);
	capn_write1(p.p, 52, s->deviceStable != 1);
}
void cereal_get_LiveLocationKalman(struct cereal_LiveLocationKalman *s, cereal_LiveLocationKalman_list l, int i) {
	cereal_LiveLocationKalman_ptr p;
	p.p = capn_getp(l.p, i, 0);
	cereal_read_LiveLocationKalman(s, p);
}
void cereal_set_LiveLocationKalman(const struct cereal_LiveLocationKalman *s, cereal_LiveLocationKalman_list l, int i) {
	cereal_LiveLocationKalman_ptr p;
	p.p = capn_getp(l.p, i, 0);
	cereal_write_LiveLocationKalman(s, p);
}

cereal_LiveLocationKalman_Measurement_ptr cereal_new_LiveLocationKalman_Measurement(struct capn_segment *s) {
	cereal_LiveLocationKalman_Measurement_ptr p;
	p.p = capn_new_struct(s, 8, 2);
	return p;
}
cereal_LiveLocationKalman_Measurement_list cereal_new_LiveLocationKalman_Measurement_list(struct capn_segment *s, int len) {
	cereal_LiveLocationKalman_Measurement_list p;
	p.p = capn_new_list(s, len, 8, 2);
	return p;
}
void cereal_read_LiveLocationKalman_Measurement(struct cereal_LiveLocationKalman_Measurement *s, cereal_LiveLocationKalman_Measurement_ptr p) {
	capn_resolve(&p.p);
	s->value.p = capn_getp(p.p, 0, 0);
	s->std.p = capn_getp(p.p, 1, 0);
	s->valid = (capn_read8(p.p, 0) & 1) != 0;
}
void cereal_write_LiveLocationKalman_Measurement(const struct cereal_LiveLocationKalman_Measurement *s, cereal_LiveLocationKalman_Measurement_ptr p) {
	capn_resolve(&p.p);
	capn_setp(p.p, 0, s->value.p);
	capn_setp(p.p, 1, s->std.p);
	capn_write1(p.p, 0, s->valid != 0);
}
void cereal_get_LiveLocationKalman_Measurement(struct cereal_LiveLocationKalman_Measurement *s, cereal_LiveLocationKalman_Measurement_list l, int i) {
	cereal_LiveLocationKalman_Measurement_ptr p;
	p.p = capn_getp(l.p, i, 0);
	cereal_read_LiveLocationKalman_Measurement(s, p);
}
void cereal_set_LiveLocationKalman_Measurement(const struct cereal_LiveLocationKalman_Measurement *s, cereal_LiveLocationKalman_Measurement_list l, int i) {
	cereal_LiveLocationKalman_Measurement_ptr p;
	p.p = capn_getp(l.p, i, 0);
	cereal_write_LiveLocationKalman_Measurement(s, p);
}
...
void cereal_read_UiLayoutState(struct cereal_UiLayoutState *s, cereal_UiLayoutState_ptr p) {
	...
	s->mockEngaged = (capn_read8(p.p, 2) & 4) != 0;
}
void cereal_write_UiLayoutState(const struct cereal_UiLayoutState *s, cereal_UiLayoutState_ptr p) {
	...
	capn_write1(p.p, 18, s->mockEngaged != 0);
}
...
void cereal_read_DriverState(struct cereal_DriverState *s, cereal_DriverState_ptr p) {
	capn_resolve(&p.p);
	s->frameId = capn_read32(p.p, 0);
	s->modelExecutionTime = capn_to_f32(capn_read32(p.p, 36));
	s->rawPred = capn_get_data(p.p, 5);
	...
	s->sgProb = capn_to_f32(capn_read32(p.p, 32));
}
void cereal_write_DriverState(const struct cereal_DriverState *s, cereal_DriverState_ptr p) {
	capn_resolve(&p.p);
	capn_write32(p.p, 0, s->frameId);
	capn_write32(p.p, 36, capn_from_f32(s->modelExecutionTime));
	capn_setp(p.p, 5, s->rawPred.p);
	...
	capn_write32(p.p, 32, capn_from_f32(s->sgProb));
}
...
void cereal_read_DMonitoringState(struct cereal_DMonitoringState *s, cereal_DMonitoringState_ptr p) {
	...
	s->isPreview = (capn_read8(p.p, 0) & 32) != 0;
	s->rhdCheckedDEPRECATED = (capn_read8(p.p, 0) & 8) != 0;
}
void cereal_write_DMonitoringState(const struct cereal_DMonitoringState *s, cereal_DMonitoringState_ptr p) {
	...
	capn_write1(p.p, 5, s->isPreview != 0);
	capn_write1(p.p, 3, s->rhdCheckedDEPRECATED != 0);
}
...
void cereal_read_Boot(struct cereal_Boot *s, cereal_Boot_ptr p) {
	...
	s->launchLog = capn_get_text(p.p, 2, capn_val0);
}
void cereal_write_Boot(const struct cereal_Boot *s, cereal_Boot_ptr p) {
	...
	capn_set_text(p.p, 2, s->launchLog);
}
...
cereal_Sentinel_ptr cereal_new_Sentinel(struct capn_segment *s) {
	cereal_Sentinel_ptr p;
	p.p = capn_new_struct(s, 8, 0);
	return p;
}
cereal_Sentinel_list cereal_new_Sentinel_list(struct capn_segment *s, int len) {
	cereal_Sentinel_list p;
	p.p = capn_new_list(s, len, 8, 0);
	return p;
}
void cereal_read_Sentinel(struct cereal_Sentinel *s, cereal_Sentinel_ptr p) {
	capn_resolve(&p.p);
	s->type = (enum cereal_Sentinel_SentinelType)(int) capn_read16(p.p, 0);
}
void cereal_write_Sentinel(const struct cereal_Sentinel *s, cereal_Sentinel_ptr p) {
	capn_resolve(&p.p);
	capn_write16(p.p, 0, (uint16_t) (s->type));
}
void cereal_get_Sentinel(struct cereal_Sentinel *s, cereal_Sentinel_list l, int i) {
	cereal_Sentinel_ptr p;
	p.p = capn_getp(l.p, i, 0);
	cereal_read_Sentinel(s, p);
}
void cereal_set_Sentinel(const struct cereal_Sentinel *s, cereal_Sentinel_list l, int i) {
	cereal_Sentinel_ptr p;
	p.p = capn_getp(l.p, i, 0);
	cereal_write_Sentinel(s, p);
}

cereal_DynamicFollowData_ptr cereal_new_DynamicFollowData(struct capn_segment *s) {
	cereal_DynamicFollowData_ptr p;
	p.p = capn_new_struct(s, 8, 0);
	return p;
}
cereal_DynamicFollowData_list cereal_new_DynamicFollowData_list(struct capn_segment *s, int len) {
	cereal_DynamicFollowData_list p;
	p.p = capn_new_list(s, len, 8, 0);
	return p;
}
void cereal_read_DynamicFollowData(struct cereal_DynamicFollowData *s, cereal_DynamicFollowData_ptr p) {
	capn_resolve(&p.p);
	s->mpcTR = capn_to_f32(capn_read32(p.p, 0));
	s->profilePred = capn_read16(p.p, 4);
}
void cereal_write_DynamicFollowData(const struct cereal_DynamicFollowData *s, cereal_DynamicFollowData_ptr p) {
	capn_resolve(&p.p);
	capn_write32(p.p, 0, capn_from_f32(s->mpcTR));
	capn_write16(p.p, 4, s->profilePred);
}
void cereal_get_DynamicFollowData(struct cereal_DynamicFollowData *s, cereal_DynamicFollowData_list l, int i) {
	cereal_DynamicFollowData_ptr p;
	p.p = capn_getp(l.p, i, 0);
	cereal_read_DynamicFollowData(s, p);
}
void cereal_set_DynamicFollowData(const struct cereal_DynamicFollowData *s, cereal_DynamicFollowData_list l, int i) {
	cereal_DynamicFollowData_ptr p;
	p.p = capn_getp(l.p, i, 0);
	cereal_write_DynamicFollowData(s, p);
}

cereal_DynamicFollowButton_ptr cereal_new_DynamicFollowButton(struct capn_segment *s) {
	cereal_DynamicFollowButton_ptr p;
	p.p = capn_new_struct(s, 8, 0);
	return p;
}
cereal_DynamicFollowButton_list cereal_new_DynamicFollowButton_list(struct capn_segment *s, int len) {
	cereal_DynamicFollowButton_list p;
	p.p = capn_new_list(s, len, 8, 0);
	return p;
}
void cereal_read_DynamicFollowButton(struct cereal_DynamicFollowButton *s, cereal_DynamicFollowButton_ptr p) {
	capn_resolve(&p.p);
	s->status = capn_read16(p.p, 0);
}
void cereal_write_DynamicFollowButton(const struct cereal_DynamicFollowButton *s, cereal_DynamicFollowButton_ptr p) {
	capn_resolve(&p.p);
	capn_write16(p.p, 0, s->status);
}
void cereal_get_DynamicFollowButton(struct cereal_DynamicFollowButton *s, cereal_DynamicFollowButton_list l, int i) {
	cereal_DynamicFollowButton_ptr p;
	p.p = capn_getp(l.p, i, 0);
	cereal_read_DynamicFollowButton(s, p);
}
void cereal_set_DynamicFollowButton(const struct cereal_DynamicFollowButton *s, cereal_DynamicFollowButton_list l, int i) {
	cereal_DynamicFollowButton_ptr p;
	p.p = capn_getp(l.p, i, 0);
	cereal_write_DynamicFollowButton(s, p);
}

cereal_LaneSpeed_ptr cereal_new_LaneSpeed(struct capn_segment *s) {
	cereal_LaneSpeed_ptr p;
	p.p = capn_new_struct(s, 8, 8);
	return p;
}
cereal_LaneSpeed_list cereal_new_LaneSpeed_list(struct capn_segment *s, int len) {
	cereal_LaneSpeed_list p;
	p.p = capn_new_list(s, len, 8, 8);
	return p;
}
void cereal_read_LaneSpeed(struct cereal_LaneSpeed *s, cereal_LaneSpeed_ptr p) {
	capn_resolve(&p.p);
	s->fastestLane = capn_get_text(p.p, 0, capn_val0);
	s->state = capn_get_text(p.p, 1, capn_val0);
	s->_new = (capn_read8(p.p, 0) & 1) != 0;
	s->leftLaneSpeeds.p = capn_getp(p.p, 2, 0);
	s->middleLaneSpeeds.p = capn_getp(p.p, 3, 0);
	s->rightLaneSpeeds.p = capn_getp(p.p, 4, 0);
	s->leftLaneDistances.p = capn_getp(p.p, 5, 0);
	s->middleLaneDistances.p = capn_getp(p.p, 6, 0);
	s->rightLaneDistances.p = capn_getp(p.p, 7, 0);
	s->leftLaneOncoming = (capn_read8(p.p, 0) & 2) != 0;
	s->rightLaneOncoming = (capn_read8(p.p, 0) & 4) != 0;
}
void cereal_write_LaneSpeed(const struct cereal_LaneSpeed *s, cereal_LaneSpeed_ptr p) {
	capn_resolve(&p.p);
	capn_set_text(p.p, 0, s->fastestLane);
	capn_set_text(p.p, 1, s->state);
	capn_write1(p.p, 0, s->_new != 0);
	capn_setp(p.p, 2, s->leftLaneSpeeds.p);
	capn_setp(p.p, 3, s->middleLaneSpeeds.p);
	capn_setp(p.p, 4, s->rightLaneSpeeds.p);
	capn_setp(p.p, 5, s->leftLaneDistances.p);
	capn_setp(p.p, 6, s->middleLaneDistances.p);
	capn_setp(p.p, 7, s->rightLaneDistances.p);
	capn_write1(p.p, 1, s->leftLaneOncoming != 0);
	capn_write1(p.p, 2, s->rightLaneOncoming != 0);
}
void cereal_get_LaneSpeed(struct cereal_LaneSpeed *s, cereal_LaneSpeed_list l, int i) {
	cereal_LaneSpeed_ptr p;
	p.p = capn_getp(l.p, i, 0);
	cereal_read_LaneSpeed(s, p);
}
void cereal_set_LaneSpeed(const struct cereal_LaneSpeed *s, cereal_LaneSpeed_list l, int i) {
	cereal_LaneSpeed_ptr p;
	p.p = capn_getp(l.p, i, 0);
	cereal_write_LaneSpeed(s, p);
}

cereal_LaneSpeedButton_ptr cereal_new_LaneSpeedButton(struct capn_segment *s) {
	cereal_LaneSpeedButton_ptr p;
	p.p = capn_new_struct(s, 8, 0);
	return p;
}
cereal_LaneSpeedButton_list cereal_new_LaneSpeedButton_list(struct capn_segment *s, int len) {
	cereal_LaneSpeedButton_list p;
	p.p = capn_new_list(s, len, 8, 0);
	return p;
}
void cereal_read_LaneSpeedButton(struct cereal_LaneSpeedButton *s, cereal_LaneSpeedButton_ptr p) {
	capn_resolve(&p.p);
	s->status = capn_read16(p.p, 0);
}
void cereal_write_LaneSpeedButton(const struct cereal_LaneSpeedButton *s, cereal_LaneSpeedButton_ptr p) {
	capn_resolve(&p.p);
	capn_write16(p.p, 0, s->status);
}
void cereal_get_LaneSpeedButton(struct cereal_LaneSpeedButton *s, cereal_LaneSpeedButton_list l, int i) {
	cereal_LaneSpeedButton_ptr p;
	p.p = capn_getp(l.p, i, 0);
	cereal_read_LaneSpeedButton(s, p);
}
void cereal_set_LaneSpeedButton(const struct cereal_LaneSpeedButton *s, cereal_LaneSpeedButton_list l, int i) {
	cereal_LaneSpeedButton_ptr p;
	p.p = capn_getp(l.p, i, 0);
	cereal_write_LaneSpeedButton(s, p);
}

cereal_DynamicCameraOffset_ptr cereal_new_DynamicCameraOffset(struct capn_segment *s) {
	cereal_DynamicCameraOffset_ptr p;
	p.p = capn_new_struct(s, 8, 0);
	return p;
}
cereal_DynamicCameraOffset_list cereal_new_DynamicCameraOffset_list(struct capn_segment *s, int len) {
	cereal_DynamicCameraOffset_list p;
	p.p = capn_new_list(s, len, 8, 0);
	return p;
}
void cereal_read_DynamicCameraOffset(struct cereal_DynamicCameraOffset *s, cereal_DynamicCameraOffset_ptr p) {
	capn_resolve(&p.p);
	s->keepingLeft = (capn_read8(p.p, 0) & 1) != 0;
	s->keepingRight = (capn_read8(p.p, 0) & 2) != 0;
}
void cereal_write_DynamicCameraOffset(const struct cereal_DynamicCameraOffset *s, cereal_DynamicCameraOffset_ptr p) {
	capn_resolve(&p.p);
	capn_write1(p.p, 0, s->keepingLeft != 0);
	capn_write1(p.p, 1, s->keepingRight != 0);
}
void cereal_get_DynamicCameraOffset(struct cereal_DynamicCameraOffset *s, cereal_DynamicCameraOffset_list l, int i) {
	cereal_DynamicCameraOffset_ptr p;
	p.p = capn_getp(l.p, i, 0);
	cereal_read_DynamicCameraOffset(s, p);
}
void cereal_set_DynamicCameraOffset(const struct cereal_DynamicCameraOffset *s, cereal_DynamicCameraOffset_list l, int i) {
	cereal_DynamicCameraOffset_ptr p;
	p.p = capn_getp(l.p, i, 0);
	cereal_write_DynamicCameraOffset(s, p);
}

cereal_ModelLongButton_ptr cereal_new_ModelLongButton(struct capn_segment *s) {
	cereal_ModelLongButton_ptr p;
	p.p = capn_new_struct(s, 8, 0);
	return p;
}
cereal_ModelLongButton_list cereal_new_ModelLongButton_list(struct capn_segment *s, int len) {
	cereal_ModelLongButton_list p;
	p.p = capn_new_list(s, len, 8, 0);
	return p;
}
void cereal_read_ModelLongButton(struct cereal_ModelLongButton *s, cereal_ModelLongButton_ptr p) {
	capn_resolve(&p.p);
	s->enabled = (capn_read8(p.p, 0) & 1) != 0;
}
void cereal_write_ModelLongButton(const struct cereal_ModelLongButton *s, cereal_ModelLongButton_ptr p) {
	capn_resolve(&p.p);
	capn_write1(p.p, 0, s->enabled != 0);
}
void cereal_get_ModelLongButton(struct cereal_ModelLongButton *s, cereal_ModelLongButton_list l, int i) {
	cereal_ModelLongButton_ptr p;
	p.p = capn_getp(l.p, i, 0);
	cereal_read_ModelLongButton(s, p);
}
void cereal_set_ModelLongButton(const struct cereal_ModelLongButton *s, cereal_ModelLongButton_list l, int i) {
	cereal_ModelLongButton_ptr p;
	p.p = capn_getp(l.p, i, 0);
	cereal_write_ModelLongButton(s, p);
}
...
void cereal_read_Event(struct cereal_Event *s, cereal_Event_ptr p) {
	...
	case cereal_Event_liveLocationKalmanDEPRECATED:
	...
	case cereal_Event_sentinel:
	case cereal_Event_wideFrame:
	case cereal_Event_modelV2:
	case cereal_Event_frontEncodeIdx:
	case cereal_Event_wideEncodeIdx:
	case cereal_Event_dynamicFollowData:
	case cereal_Event_dynamicFollowButton:
	case cereal_Event_laneSpeed:
	case cereal_Event_laneSpeedButton:
	case cereal_Event_dynamicCameraOffset:
	case cereal_Event_modelLongButton:
		s->modelLongButton.p = capn_getp(p.p, 0, 0);
		break;
	default:
		break;
	}
...
void cereal_write_Event(const struct cereal_Event *s, cereal_Event_ptr p) {
	...
	case cereal_Event_dynamicCameraOffset:
	case cereal_Event_modelLongButton:
		capn_setp(p.p, 0, s->modelLongButton.p);
		break;
	default:
		break;
	}
