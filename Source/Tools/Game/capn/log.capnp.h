...
struct cereal_ModelDataV2;
struct cereal_ModelDataV2_XYZTData;
struct cereal_ModelDataV2_LeadDataV2;
struct cereal_ModelDataV2_MetaData;
...
struct cereal_LiveLocationKalman;
struct cereal_LiveLocationKalman_Measurement;
...
struct cereal_Sentinel;
struct cereal_DynamicFollowData;
struct cereal_DynamicFollowButton;
struct cereal_LaneSpeed;
struct cereal_LaneSpeedButton;
struct cereal_DynamicCameraOffset;
struct cereal_ModelLongButton;
struct cereal_Event;
...
typedef struct {capn_ptr p;} cereal_ModelDataV2_ptr;
typedef struct {capn_ptr p;} cereal_ModelDataV2_XYZTData_ptr;
typedef struct {capn_ptr p;} cereal_ModelDataV2_LeadDataV2_ptr;
typedef struct {capn_ptr p;} cereal_ModelDataV2_MetaData_ptr;
...
typedef struct {capn_ptr p;} cereal_LiveLocationKalman_ptr;
typedef struct {capn_ptr p;} cereal_LiveLocationKalman_Measurement_ptr;
...
typedef struct {capn_ptr p;} cereal_Sentinel_ptr;
typedef struct {capn_ptr p;} cereal_DynamicFollowData_ptr;
typedef struct {capn_ptr p;} cereal_DynamicFollowButton_ptr;
typedef struct {capn_ptr p;} cereal_LaneSpeed_ptr;
typedef struct {capn_ptr p;} cereal_LaneSpeedButton_ptr;
typedef struct {capn_ptr p;} cereal_DynamicCameraOffset_ptr;
typedef struct {capn_ptr p;} cereal_ModelLongButton_ptr;
...
typedef struct {capn_ptr p;} cereal_ModelDataV2_list;
typedef struct {capn_ptr p;} cereal_ModelDataV2_XYZTData_list;
typedef struct {capn_ptr p;} cereal_ModelDataV2_LeadDataV2_list;
typedef struct {capn_ptr p;} cereal_ModelDataV2_MetaData_list;
...
typedef struct {capn_ptr p;} cereal_LiveLocationKalman_list;
typedef struct {capn_ptr p;} cereal_LiveLocationKalman_Measurement_list;
...
typedef struct {capn_ptr p;} cereal_Sentinel_list;
typedef struct {capn_ptr p;} cereal_DynamicFollowData_list;
typedef struct {capn_ptr p;} cereal_DynamicFollowButton_list;
typedef struct {capn_ptr p;} cereal_LaneSpeed_list;
typedef struct {capn_ptr p;} cereal_LaneSpeedButton_list;
typedef struct {capn_ptr p;} cereal_DynamicCameraOffset_list;
typedef struct {capn_ptr p;} cereal_ModelLongButton_list;
...
enum cereal_SensorEventData_SensorSource {
	...
	cereal_SensorEventData_SensorSource_bmx055 = 8,
	cereal_SensorEventData_SensorSource_rpr0521 = 9
};
...
enum cereal_ThermalData_NetworkStrength {
	cereal_ThermalData_NetworkStrength_unknown = 0,
	cereal_ThermalData_NetworkStrength_poor = 1,
	cereal_ThermalData_NetworkStrength_moderate = 2,
	cereal_ThermalData_NetworkStrength_good = 3,
	cereal_ThermalData_NetworkStrength_great = 4
};
...
enum cereal_HealthData_FaultType {
	...
	cereal_HealthData_FaultType_unusedInterruptHandled = 1,
	cereal_HealthData_FaultType_interruptRateCan1 = 2,
	cereal_HealthData_FaultType_interruptRateCan2 = 3,
	cereal_HealthData_FaultType_interruptRateCan3 = 4,
	cereal_HealthData_FaultType_interruptRateTach = 5,
	cereal_HealthData_FaultType_interruptRateGmlan = 6,
	cereal_HealthData_FaultType_interruptRateInterrupts = 7,
	cereal_HealthData_FaultType_interruptRateSpiDma = 8,
	cereal_HealthData_FaultType_interruptRateSpiCs = 9,
	cereal_HealthData_FaultType_interruptRateUart1 = 10,
	cereal_HealthData_FaultType_interruptRateUart2 = 11,
	cereal_HealthData_FaultType_interruptRateUart3 = 12,
	cereal_HealthData_FaultType_interruptRateUart5 = 13,
	cereal_HealthData_FaultType_interruptRateUartDma = 14,
	cereal_HealthData_FaultType_interruptRateUsb = 15,
	cereal_HealthData_FaultType_interruptRateTim1 = 16,
	cereal_HealthData_FaultType_interruptRateTim3 = 17,
	cereal_HealthData_FaultType_registerDivergent = 18,
	cereal_HealthData_FaultType_interruptRateKlineInit = 19,
	cereal_HealthData_FaultType_interruptRateClockSource = 20,
	cereal_HealthData_FaultType_interruptRateTim9 = 21
};
...
enum cereal_HealthData_HwType {
	...
	cereal_HealthData_HwType_dos = 6
};
...
enum cereal_Plan_LongitudinalPlanSource {
	...
	cereal_Plan_LongitudinalPlanSource_dynamicSpeed = 5,
	cereal_Plan_LongitudinalPlanSource_curveSlowdown = 6
};
...
enum cereal_LiveLocationKalman_Status {
	cereal_LiveLocationKalman_Status_uninitialized = 0,
	cereal_LiveLocationKalman_Status_uncalibrated = 1,
	cereal_LiveLocationKalman_Status_valid = 2
};
...
enum cereal_UiLayoutState_App {
	...
	cereal_UiLayoutState_App_none = 4
};

enum cereal_Sentinel_SentinelType {
	cereal_Sentinel_SentinelType_endOfSegment = 0,
	cereal_Sentinel_SentinelType_endOfRoute = 1,
	cereal_Sentinel_SentinelType_startOfSegment = 2,
	cereal_Sentinel_SentinelType_startOfRoute = 3
};
...
struct cereal_FrameData {
	...
	capn_data image;
	float gainFrac;
	capn_list16 focusVal;
	capn_list8 focusConf;
	capn_list16 sharpnessScore;
	int32_t recoverState;
...
static const size_t cereal_FrameData_pointer_count = 6;

static const size_t cereal_FrameData_struct_bytes_count = 112;
...
enum cereal_SensorEventData_which {
	...
	cereal_SensorEventData_temperature = 9
};
...
struct cereal_ThermalData {
	uint16_t cpu0DEPRECATED;
	uint16_t cpu1DEPRECATED;
	uint16_t cpu2DEPRECATED;
	uint16_t cpu3DEPRECATED;
	uint16_t memDEPRECATED;
	uint16_t gpuDEPRECATED;
	uint32_t batDEPRECATED;
	uint16_t pa0DEPRECATED;
	float freeSpace;
	...
	enum cereal_ThermalData_NetworkStrength networkStrength;
	uint32_t carBatteryCapacity;
	uint16_t fanSpeed;
	unsigned started : 1;
	uint64_t startedTs;
...
static const size_t cereal_ThermalData_word_count = 9;

static const size_t cereal_ThermalData_pointer_count = 3;

static const size_t cereal_ThermalData_struct_bytes_count = 96;
...
struct cereal_LiveCalibrationData {
	...
	capn_list32 rpyCalibSpread;
};

static const size_t cereal_LiveCalibrationData_word_count = 2;

static const size_t cereal_LiveCalibrationData_pointer_count = 6;

static const size_t cereal_LiveCalibrationData_struct_bytes_count = 64;
...
static const size_t cereal_ModelData_word_count = 3;

static const size_t cereal_ModelData_pointer_count = 11;

static const size_t cereal_ModelData_struct_bytes_count = 112;
...
static const size_t cereal_ModelData_PathData_word_count = 2;

static const size_t cereal_ModelData_PathData_pointer_count = 3;

static const size_t cereal_ModelData_PathData_struct_bytes_count = 40;
...
struct cereal_ModelData_MetaData {
	...
	capn_list32 desireState;
};

static const size_t cereal_ModelData_MetaData_word_count = 2;

static const size_t cereal_ModelData_MetaData_pointer_count = 2;

static const size_t cereal_ModelData_MetaData_struct_bytes_count = 32;

struct cereal_ModelData_LongitudinalData {
	capn_list32 distances;
	capn_list32 speeds;
...
static const size_t cereal_ModelData_LongitudinalData_pointer_count = 3;

static const size_t cereal_ModelData_LongitudinalData_struct_bytes_count = 24;
...
struct cereal_ModelDataV2 {
	...
	float modelExecutionTime;
	capn_data rawPred;
	cereal_ModelDataV2_XYZTData_ptr position;
	cereal_ModelDataV2_XYZTData_ptr orientation;
	cereal_ModelDataV2_XYZTData_ptr velocity;
	cereal_ModelDataV2_XYZTData_ptr orientationRate;
	cereal_ModelDataV2_XYZTData_list laneLines;
	capn_list32 laneLineProbs;
	capn_list32 laneLineStds;
	cereal_ModelDataV2_XYZTData_list roadEdges;
	capn_list32 roadEdgeStds;
	cereal_ModelDataV2_LeadDataV2_list leads;
	cereal_ModelDataV2_MetaData_ptr meta;
};

static const size_t cereal_ModelDataV2_word_count = 3;

static const size_t cereal_ModelDataV2_pointer_count = 12;

static const size_t cereal_ModelDataV2_struct_bytes_count = 120;
...
static const size_t cereal_ModelDataV2_XYZTData_word_count = 0;

static const size_t cereal_ModelDataV2_XYZTData_pointer_count = 7;

static const size_t cereal_ModelDataV2_XYZTData_struct_bytes_count = 56;
...
static const size_t cereal_ModelDataV2_LeadDataV2_word_count = 1;

static const size_t cereal_ModelDataV2_LeadDataV2_pointer_count = 2;

static const size_t cereal_ModelDataV2_LeadDataV2_struct_bytes_count = 24;
...
static const size_t cereal_ModelDataV2_MetaData_word_count = 2;

static const size_t cereal_ModelDataV2_MetaData_pointer_count = 2;

static const size_t cereal_ModelDataV2_MetaData_struct_bytes_count = 32;
...
static const size_t cereal_EncodeIndex_word_count = 5;

static const size_t cereal_EncodeIndex_pointer_count = 0;

static const size_t cereal_EncodeIndex_struct_bytes_count = 40;
...
struct cereal_LiveLocationKalman {
	cereal_LiveLocationKalman_Measurement_ptr positionECEF;
	cereal_LiveLocationKalman_Measurement_ptr positionGeodetic;
	cereal_LiveLocationKalman_Measurement_ptr velocityECEF;
	cereal_LiveLocationKalman_Measurement_ptr velocityNED;
	cereal_LiveLocationKalman_Measurement_ptr velocityDevice;
	cereal_LiveLocationKalman_Measurement_ptr accelerationDevice;
	cereal_LiveLocationKalman_Measurement_ptr orientationECEF;
	cereal_LiveLocationKalman_Measurement_ptr calibratedOrientationECEF;
	cereal_LiveLocationKalman_Measurement_ptr orientationNED;
	cereal_LiveLocationKalman_Measurement_ptr angularVelocityDevice;
	cereal_LiveLocationKalman_Measurement_ptr orientationNEDCalibrated;
	cereal_LiveLocationKalman_Measurement_ptr velocityCalibrated;
	cereal_LiveLocationKalman_Measurement_ptr accelerationCalibrated;
	cereal_LiveLocationKalman_Measurement_ptr angularVelocityCalibrated;
	int32_t gpsWeek;
	double gpsTimeOfWeek;
	enum cereal_LiveLocationKalman_Status status;
	int64_t unixTimestampMillis;
	unsigned inputsOK : 1;
	unsigned posenetOK : 1;
	unsigned gpsOK : 1;
	unsigned sensorsOK : 1;
	unsigned deviceStable : 1;
};

static const size_t cereal_LiveLocationKalman_word_count = 3;

static const size_t cereal_LiveLocationKalman_pointer_count = 14;

static const size_t cereal_LiveLocationKalman_struct_bytes_count = 136;
...
static const size_t cereal_LiveLocationKalman_Measurement_word_count = 1;

static const size_t cereal_LiveLocationKalman_Measurement_pointer_count = 2;

static const size_t cereal_LiveLocationKalman_Measurement_struct_bytes_count = 24;
...
static const size_t cereal_DriverState_word_count = 5;

static const size_t cereal_DriverState_pointer_count = 6;

static const size_t cereal_DriverState_struct_bytes_count = 88;
...
struct cereal_DMonitoringState {
	...
	unsigned isLowStd : 1;
	uint32_t hiStdCount;
	unsigned isPreview : 1;
	unsigned rhdCheckedDEPRECATED : 1;
};
...
static const size_t cereal_Boot_pointer_count = 3;

static const size_t cereal_Boot_struct_bytes_count = 32;
...
struct cereal_Sentinel {
	enum cereal_Sentinel_SentinelType type;
};

static const size_t cereal_Sentinel_word_count = 1;

static const size_t cereal_Sentinel_pointer_count = 0;

static const size_t cereal_Sentinel_struct_bytes_count = 8;

struct cereal_DynamicFollowData {
	float mpcTR;
	uint16_t profilePred;
};

static const size_t cereal_DynamicFollowData_word_count = 1;

static const size_t cereal_DynamicFollowData_pointer_count = 0;

static const size_t cereal_DynamicFollowData_struct_bytes_count = 8;

struct cereal_DynamicFollowButton {
	uint16_t status;
};

static const size_t cereal_DynamicFollowButton_word_count = 1;

static const size_t cereal_DynamicFollowButton_pointer_count = 0;

static const size_t cereal_DynamicFollowButton_struct_bytes_count = 8;

struct cereal_LaneSpeed {
	capn_text fastestLane;
	capn_text state;
	unsigned _new : 1;
	capn_list32 leftLaneSpeeds;
	capn_list32 middleLaneSpeeds;
	capn_list32 rightLaneSpeeds;
	capn_list32 leftLaneDistances;
	capn_list32 middleLaneDistances;
	capn_list32 rightLaneDistances;
	unsigned leftLaneOncoming : 1;
	unsigned rightLaneOncoming : 1;
};

static const size_t cereal_LaneSpeed_word_count = 1;

static const size_t cereal_LaneSpeed_pointer_count = 8;

static const size_t cereal_LaneSpeed_struct_bytes_count = 72;

struct cereal_LaneSpeedButton {
	uint16_t status;
};

static const size_t cereal_LaneSpeedButton_word_count = 1;

static const size_t cereal_LaneSpeedButton_pointer_count = 0;

static const size_t cereal_LaneSpeedButton_struct_bytes_count = 8;

struct cereal_DynamicCameraOffset {
	unsigned keepingLeft : 1;
	unsigned keepingRight : 1;
};

static const size_t cereal_DynamicCameraOffset_word_count = 1;

static const size_t cereal_DynamicCameraOffset_pointer_count = 0;

static const size_t cereal_DynamicCameraOffset_struct_bytes_count = 8;

struct cereal_ModelLongButton {
	unsigned enabled : 1;
};

static const size_t cereal_ModelLongButton_word_count = 1;

static const size_t cereal_ModelLongButton_pointer_count = 0;

static const size_t cereal_ModelLongButton_struct_bytes_count = 8;
enum cereal_Event_which {
	...
	cereal_Event_liveLocationKalmanDEPRECATED = 50,
	...
	cereal_Event_liveLocationKalman = 70,
	cereal_Event_sentinel = 71,
	cereal_Event_wideFrame = 72,
	cereal_Event_modelV2 = 73,
	cereal_Event_frontEncodeIdx = 74,
	cereal_Event_wideEncodeIdx = 75,
	cereal_Event_dynamicFollowData = 76,
	cereal_Event_dynamicFollowButton = 77,
	cereal_Event_laneSpeed = 78,
	cereal_Event_laneSpeedButton = 79,
	cereal_Event_dynamicCameraOffset = 80,
	cereal_Event_modelLongButton = 81
};
...
struct cereal_Event {
	...
	union {
		...
		cereal_AndroidLogEntry_ptr androidLog;
		...
		cereal_LiveLocationData_ptr liveLocationKalmanDEPRECATED;
		...
		cereal_LiveLocationKalman_ptr liveLocationKalman;
		cereal_Sentinel_ptr sentinel;
		cereal_FrameData_ptr wideFrame;
		cereal_ModelDataV2_ptr modelV2;
		cereal_EncodeIndex_ptr frontEncodeIdx;
		cereal_EncodeIndex_ptr wideEncodeIdx;
		cereal_DynamicFollowData_ptr dynamicFollowData;
		cereal_DynamicFollowButton_ptr dynamicFollowButton;
		cereal_LaneSpeed_ptr laneSpeed;
		cereal_LaneSpeedButton_ptr laneSpeedButton;
		cereal_DynamicCameraOffset_ptr dynamicCameraOffset;
		cereal_ModelLongButton_ptr modelLongButton;
	};
};
...
cereal_ModelDataV2_ptr cereal_new_ModelDataV2(struct capn_segment*);
cereal_ModelDataV2_XYZTData_ptr cereal_new_ModelDataV2_XYZTData(struct capn_segment*);
cereal_ModelDataV2_LeadDataV2_ptr cereal_new_ModelDataV2_LeadDataV2(struct capn_segment*);
cereal_ModelDataV2_MetaData_ptr cereal_new_ModelDataV2_MetaData(struct capn_segment*);
...
cereal_LiveLocationKalman_ptr cereal_new_LiveLocationKalman(struct capn_segment*);
cereal_LiveLocationKalman_Measurement_ptr cereal_new_LiveLocationKalman_Measurement(struct capn_segment*);
...
cereal_Sentinel_ptr cereal_new_Sentinel(struct capn_segment*);
cereal_DynamicFollowData_ptr cereal_new_DynamicFollowData(struct capn_segment*);
cereal_DynamicFollowButton_ptr cereal_new_DynamicFollowButton(struct capn_segment*);
cereal_LaneSpeed_ptr cereal_new_LaneSpeed(struct capn_segment*);
cereal_LaneSpeedButton_ptr cereal_new_LaneSpeedButton(struct capn_segment*);
cereal_DynamicCameraOffset_ptr cereal_new_DynamicCameraOffset(struct capn_segment*);
cereal_ModelLongButton_ptr cereal_new_ModelLongButton(struct capn_segment*);
...
cereal_ModelDataV2_list cereal_new_ModelDataV2_list(struct capn_segment*, int len);
cereal_ModelDataV2_XYZTData_list cereal_new_ModelDataV2_XYZTData_list(struct capn_segment*, int len);
cereal_ModelDataV2_LeadDataV2_list cereal_new_ModelDataV2_LeadDataV2_list(struct capn_segment*, int len);
cereal_ModelDataV2_MetaData_list cereal_new_ModelDataV2_MetaData_list(struct capn_segment*, int len);
...
cereal_LiveLocationKalman_list cereal_new_LiveLocationKalman_list(struct capn_segment*, int len);
cereal_LiveLocationKalman_Measurement_list cereal_new_LiveLocationKalman_Measurement_list(struct capn_segment*, int len);
...
cereal_Sentinel_list cereal_new_Sentinel_list(struct capn_segment*, int len);
cereal_DynamicFollowData_list cereal_new_DynamicFollowData_list(struct capn_segment*, int len);
cereal_DynamicFollowButton_list cereal_new_DynamicFollowButton_list(struct capn_segment*, int len);
cereal_LaneSpeed_list cereal_new_LaneSpeed_list(struct capn_segment*, int len);
cereal_LaneSpeedButton_list cereal_new_LaneSpeedButton_list(struct capn_segment*, int len);
cereal_DynamicCameraOffset_list cereal_new_DynamicCameraOffset_list(struct capn_segment*, int len);
cereal_ModelLongButton_list cereal_new_ModelLongButton_list(struct capn_segment*, int len);
...
void cereal_read_ModelDataV2(struct cereal_ModelDataV2*, cereal_ModelDataV2_ptr);
void cereal_read_ModelDataV2_XYZTData(struct cereal_ModelDataV2_XYZTData*, cereal_ModelDataV2_XYZTData_ptr);
void cereal_read_ModelDataV2_LeadDataV2(struct cereal_ModelDataV2_LeadDataV2*, cereal_ModelDataV2_LeadDataV2_ptr);
void cereal_read_ModelDataV2_MetaData(struct cereal_ModelDataV2_MetaData*, cereal_ModelDataV2_MetaData_ptr);
...
void cereal_read_LiveLocationKalman(struct cereal_LiveLocationKalman*, cereal_LiveLocationKalman_ptr);
void cereal_read_LiveLocationKalman_Measurement(struct cereal_LiveLocationKalman_Measurement*, cereal_LiveLocationKalman_Measurement_ptr);
...
void cereal_read_Sentinel(struct cereal_Sentinel*, cereal_Sentinel_ptr);
void cereal_read_DynamicFollowData(struct cereal_DynamicFollowData*, cereal_DynamicFollowData_ptr);
void cereal_read_DynamicFollowButton(struct cereal_DynamicFollowButton*, cereal_DynamicFollowButton_ptr);
void cereal_read_LaneSpeed(struct cereal_LaneSpeed*, cereal_LaneSpeed_ptr);
void cereal_read_LaneSpeedButton(struct cereal_LaneSpeedButton*, cereal_LaneSpeedButton_ptr);
void cereal_read_DynamicCameraOffset(struct cereal_DynamicCameraOffset*, cereal_DynamicCameraOffset_ptr);
void cereal_read_ModelLongButton(struct cereal_ModelLongButton*, cereal_ModelLongButton_ptr);
...
void cereal_write_ModelDataV2(const struct cereal_ModelDataV2*, cereal_ModelDataV2_ptr);
void cereal_write_ModelDataV2_XYZTData(const struct cereal_ModelDataV2_XYZTData*, cereal_ModelDataV2_XYZTData_ptr);
void cereal_write_ModelDataV2_LeadDataV2(const struct cereal_ModelDataV2_LeadDataV2*, cereal_ModelDataV2_LeadDataV2_ptr);
void cereal_write_ModelDataV2_MetaData(const struct cereal_ModelDataV2_MetaData*, cereal_ModelDataV2_MetaData_ptr);
...
void cereal_write_LiveLocationKalman(const struct cereal_LiveLocationKalman*, cereal_LiveLocationKalman_ptr);
void cereal_write_LiveLocationKalman_Measurement(const struct cereal_LiveLocationKalman_Measurement*, cereal_LiveLocationKalman_Measurement_ptr);
...
void cereal_write_Sentinel(const struct cereal_Sentinel*, cereal_Sentinel_ptr);
void cereal_write_DynamicFollowData(const struct cereal_DynamicFollowData*, cereal_DynamicFollowData_ptr);
void cereal_write_DynamicFollowButton(const struct cereal_DynamicFollowButton*, cereal_DynamicFollowButton_ptr);
void cereal_write_LaneSpeed(const struct cereal_LaneSpeed*, cereal_LaneSpeed_ptr);
void cereal_write_LaneSpeedButton(const struct cereal_LaneSpeedButton*, cereal_LaneSpeedButton_ptr);
void cereal_write_DynamicCameraOffset(const struct cereal_DynamicCameraOffset*, cereal_DynamicCameraOffset_ptr);
void cereal_write_ModelLongButton(const struct cereal_ModelLongButton*, cereal_ModelLongButton_ptr);
...
void cereal_get_ModelDataV2(struct cereal_ModelDataV2*, cereal_ModelDataV2_list, int i);
void cereal_get_ModelDataV2_XYZTData(struct cereal_ModelDataV2_XYZTData*, cereal_ModelDataV2_XYZTData_list, int i);
void cereal_get_ModelDataV2_LeadDataV2(struct cereal_ModelDataV2_LeadDataV2*, cereal_ModelDataV2_LeadDataV2_list, int i);
void cereal_get_ModelDataV2_MetaData(struct cereal_ModelDataV2_MetaData*, cereal_ModelDataV2_MetaData_list, int i);
...
void cereal_get_LiveLocationKalman(struct cereal_LiveLocationKalman*, cereal_LiveLocationKalman_list, int i);
void cereal_get_LiveLocationKalman_Measurement(struct cereal_LiveLocationKalman_Measurement*, cereal_LiveLocationKalman_Measurement_list, int i);
...
void cereal_get_Sentinel(struct cereal_Sentinel*, cereal_Sentinel_list, int i);
void cereal_get_DynamicFollowData(struct cereal_DynamicFollowData*, cereal_DynamicFollowData_list, int i);
void cereal_get_DynamicFollowButton(struct cereal_DynamicFollowButton*, cereal_DynamicFollowButton_list, int i);
void cereal_get_LaneSpeed(struct cereal_LaneSpeed*, cereal_LaneSpeed_list, int i);
void cereal_get_LaneSpeedButton(struct cereal_LaneSpeedButton*, cereal_LaneSpeedButton_list, int i);
void cereal_get_DynamicCameraOffset(struct cereal_DynamicCameraOffset*, cereal_DynamicCameraOffset_list, int i);
void cereal_get_ModelLongButton(struct cereal_ModelLongButton*, cereal_ModelLongButton_list, int i);
...
void cereal_set_ModelDataV2(const struct cereal_ModelDataV2*, cereal_ModelDataV2_list, int i);
void cereal_set_ModelDataV2_XYZTData(const struct cereal_ModelDataV2_XYZTData*, cereal_ModelDataV2_XYZTData_list, int i);
void cereal_set_ModelDataV2_LeadDataV2(const struct cereal_ModelDataV2_LeadDataV2*, cereal_ModelDataV2_LeadDataV2_list, int i);
void cereal_set_ModelDataV2_MetaData(const struct cereal_ModelDataV2_MetaData*, cereal_ModelDataV2_MetaData_list, int i);
...
void cereal_set_LiveLocationKalman(const struct cereal_LiveLocationKalman*, cereal_LiveLocationKalman_list, int i);
void cereal_set_LiveLocationKalman_Measurement(const struct cereal_LiveLocationKalman_Measurement*, cereal_LiveLocationKalman_Measurement_list, int i);
...
void cereal_set_Sentinel(const struct cereal_Sentinel*, cereal_Sentinel_list, int i);
void cereal_set_DynamicFollowData(const struct cereal_DynamicFollowData*, cereal_DynamicFollowData_list, int i);
void cereal_set_DynamicFollowButton(const struct cereal_DynamicFollowButton*, cereal_DynamicFollowButton_list, int i);
void cereal_set_LaneSpeed(const struct cereal_LaneSpeed*, cereal_LaneSpeed_list, int i);
void cereal_set_LaneSpeedButton(const struct cereal_LaneSpeedButton*, cereal_LaneSpeedButton_list, int i);
void cereal_set_DynamicCameraOffset(const struct cereal_DynamicCameraOffset*, cereal_DynamicCameraOffset_list, int i);
void cereal_set_ModelLongButton(const struct cereal_ModelLongButton*, cereal_ModelLongButton_list, int i);
